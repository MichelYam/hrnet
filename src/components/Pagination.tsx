...
//             return res;
//         } else {
//             if (actualPage % 5 >= 0 && actualPage > 4 && actualPage + 2 < pageAmount) {
//                 return [1, actualPage - 1, actualPage, actualPage + 1, pageAmount];
//             } else if (actualPage % 5 >= 0 && actualPage > 4 && actualPage + 2 >= pageAmount) {
//                 return [1, pageAmount - 3, pageAmount - 2, pageAmount - 1, pageAmount];
//             } else {
